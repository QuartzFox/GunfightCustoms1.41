...
buildweaponmap()
{
    ...
    applyarenablueprintdefaultattachmentoverrides();
    var_16 = [];
...
applyarenablueprintdefaultattachmentoverrides()
{
    var_0 = "mp/classtable_arena_blueprints.csv";

    if ( !tableexists( var_0 ) )
        return;

    var_1 = tablelookuprownum( var_0, 0, "loadoutPrimary" );

    if ( !isdefined( var_1 ) || var_1 < 0 )
        return;

    var_2 = [];
    var_2[0] = tablelookuprownum( var_0, 0, "loadoutPrimaryAttachment1" );
    var_2[1] = tablelookuprownum( var_0, 0, "loadoutPrimaryAttachment2" );
    var_2[2] = tablelookuprownum( var_0, 0, "loadoutPrimaryAttachment3" );
    var_2[3] = tablelookuprownum( var_0, 0, "loadoutPrimaryAttachment4" );
    var_2[4] = tablelookuprownum( var_0, 0, "loadoutPrimaryAttachment5" );
    var_3 = [];

    for ( var_4 = 1; var_4 < 512; var_4++ )
    {
        ...
        if ( var_5 == "none" || isdefined( var_3[var_5] ) )
            continue;

        var_6 = buildarenablueprintattachmentidmap( var_0, var_2, var_4 );

        if ( var_6.size <= 0 )
            continue;

        applyarenablueprintattachmentidmap( var_5, var_6 );
        var_3[var_5] = 1;
    }
}

buildarenablueprintattachmentidmap( var_0, var_1, var_2 )
{
    var_3 = [];
    ...
    for ( var_4 = 0; var_4 < var_1.size; var_4++ )
    {
        ...
        addarenablueprintattachmenttoken( var_3, var_6 );
    }

    return var_3;
}

addarenablueprintattachmenttoken( var_0, var_1 )
{
    var_2 = strtok( var_1, "|" );

    if ( !isdefined( var_2 ) || var_2.size <= 0 || var_2[0] == "" || var_2[0] == "none" )
        return;

    if ( var_2.size == 2 )
        var_0[var_2[0]] = int( var_2[1] );
    else
        var_0[var_2[0]] = 0;
}

applyarenablueprintattachmentidmap( var_0, var_1 )
{
    if ( !isdefined( level.weaponmapdata[var_0] ) )
        return;

    if ( !isdefined( level.weaponmapdata[var_0].attachdefaulttoidmap ) )
        level.weaponmapdata[var_0].attachdefaulttoidmap = [];

    foreach ( var_3, var_2 in var_1 )
        level.weaponmapdata[var_0].attachdefaulttoidmap[var_3] = var_2;
}
